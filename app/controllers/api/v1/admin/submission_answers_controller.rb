class Api::V1::Admin::SubmissionAnswersController < Api::V1::Admin::ApplicationController
  ...
  def index
    ...
    render json: @submission_answers, include: ['*', 'submission.challenge.subject.curriculum', 'question.topics', 'question.exam']
  end
  ...
  private
    ...
    def set_submission_answers
      ...
      @submission_answers = pundit_scope(SubmissionAnswer.all).preload(:user, { submission: { challenge: { subject: :curriculum } } }, { question: [:topics, :exam] })
